                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url(); ?>/admin/insert_registration_concept" class="form-horizontal" name="add_article" id="add_article" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Writer<font color="red"> *</font></label>
                                          <div class="controls">
                                          <input type="text" placeholder="" class="input-xlarge" name="writer" />
                                          </div>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Description<font color="red"> *</font></label>
                                          <div class="controls">
                                        <textarea  name="discription"  style="width: 295px; height: 91px;">
                              ...
                              <div class="title"><b>FRAPA</b></div>
                                 ...
                                 <div class="row-fluid">            
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Registration Name.<font color="red"> *</font></label>
                                          <div class="controls">
                               ...
                               <div class="title"> <b>FWA</b></div>
                                ...
                                <div class="title"><b>TradeMark</b></div>
                                 ...
                                 <div class="row-fluid">            
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Registration Expire Date<font color="red"> *</font></label>
                                          <div class="controls">
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Status<font color="red"> *</font></label>
                                          <div class="controls">
                                          <input type="text" placeholder="" class="input-xlarge" name="status" id="status"/>
                                          </div>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Diary no<font color="red"> *</font></label>
                                          <div class="controls">
                                          <input type="text" placeholder="" class="input-xlarge" name="diaryno">
                                          </div>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >application date <font color="red"> *</font></label>
                                          <div class="controls">
                                          <input type="text" placeholder="" class="input-xlarge" name="application_date" id="application_date"/>
                                          </div>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Reg diary no <font color="red"> *</font></label>
                                          <div class="controls">
                                          <input type="text" placeholder="" class="input-xlarge" name="reg_diary_no" id="reg_diary_no"/>
                                          </div>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Confirmation date<font color="red"> *</font></label>
                                          <div class="controls">
                                          <input type="text" placeholder="" class="input-xlarge" name="Confirmation_date" id="Confirmation_date"/>
                                          </div>
                                        </div>
                                    </div>
                                </div>
