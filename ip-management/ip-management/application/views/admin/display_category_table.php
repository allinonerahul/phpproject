...
<?php $category_1 = $category[0]['category'];?>
 <a style="margin-top:22px;" class="btn btn-primary" href="<?php echo site_url() ?>/admin/export_to_excel_category?category=<?php echo $category_1; ?>">Export to Excel</a>
  <table class="table table-bordered">
                              ...
                              <?php $sr=1; foreach($category as $val){ 
...
// print_r($category);
                          ...
                          <tr>
                                ...
                                <td style="width:20%"><?php echo $val['discription']; ?></td>
