<?php $genre_1 = $genere[0]['genre']; ?>

 <a style="margin-top:22px;" class="btn btn-primary" href="<?php echo site_url() ?>/admin/export_to_excel?genre=<?php echo $genre_1; ?>">Export to Excel</a>
  ...
  <table class="table table-bordered">
                              ...
                              <?php $sr=1; foreach($genere as $val){ 
