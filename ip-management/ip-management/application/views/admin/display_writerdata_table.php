...
<a style="margin-top:22px;" class="btn btn-primary" href="<?php echo site_url() ?>/admin/export_to_excel_writers?writer=<?php echo $writer_1; ?>">Export to Excel</a>
