                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url(); ?>/admin/edit_insert_concept" class="form-horizontal" name="add_article" id="add_article" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Concept Name<font color="red"> *</font></label>
                                        <div class="controls"> 
    <input type="text" placeholder="Concept Name" class="input-xlarge" name="c_name" value="<?php echo $value['concept_name']; ?>" required/>

 <input type="hidden" placeholder="" class="input-xlarge" name="id" id="id" value="<?php echo $value['id']; ?>" required/>
                                 ...
                                 <div class="row-fluid">            
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Expiry Date<font color="red"> *</font></label>
                                          <div class="controls">
                                          <input type="text" placeholder="" class="input-xlarge" name="cr_exp_date"  id="cr_exp_date" value="<?php echo $value['cr_exp_date'];?>"/>
                                          </div>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Registered For<font color="red"> *</font></label>
                                          <div class="controls">
                                          <input type="text" placeholder="" class="input-xlarge" name="reg_for" value="<?php echo $value['reg_for'];?>"/>
                                          </div>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Author/Writer<font color="red"> *</font></label>
                                          <div class="controls">
                                          <input type="text" placeholder="" class="input-xlarge" name="author" value="<?php echo $value['author'];?>"/>
                                          </div>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Synopsis<font color="red"> *</font></label>
                                          <div class="controls">
                                          <textarea class="input-xlarge" name="synopsis"/><?php echo $value['synopsis'];?></textarea>
                                          </div>
                                        </div>
                                    </div>
                                </div> -->
