s<link href="<?php echo base_url(); ?>css/admin/pages/dashboard.css" rel="stylesheet" />
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url(); ?>/admin/edit_insert_domainregistration" class="form-horizontal" name="add_article" id="add_article" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Domain Name<font color="red"> *</font></label>
                                          <div class="controls">
                                          <input type="text" placeholder="Domain Name" class="input-xlarge" name="domanin_name" value="<?php echo $value['domanin_name'];?>"required/>

     <input type="hidden" placeholder="" class="input-xlarge" name="domain_id" value="<?php echo $value['domain_id'];
                                            ?>"required/>
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Registrar<font color="red"> *</font></label>
                                          <div class="controls">
                                          <input type="text" placeholder="" class="input-xlarge" name="register" value="<?php echo $value['register'] ?>" required/>
                                          </div>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Registered Email<font color="red"> *</font></label>
                                          <div class="controls">
                                          <input type="text" placeholder="" class="input-xlarge" name="registeremail" value="<?php echo $value['registeremail']; ?>"/>
                                          </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row-fluid">            
                                  <div class="span6 ">
                                    ...
                                    <label class="control-label" >Registered Contact<font color="red"> *</font></label>
                                          <div class="controls">
                         <input type="text" placeholder="" class="input-xlarge" name="register_contect" value="<?php echo $value['register_contect']?> "  />
                                          </div>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Registration Date<font color="red"> *</font></label>
                                          <div class="controls">
                      <input type="text" placeholder="" class="input-xlarge" name="reg_date" id="reg_date" value="<?php echo $value['reg_date'];?>"/>
                                          </div>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Registration Expiry<font color="red"> *</font></label>
                                          <div class="controls">
                             <input type="text" placeholder="" class="input-xlarge" name="exp_date" id="exp_date" value="<?php echo $value['exp_date'];?>"/>
                                          </div>
                                        </div>
                                    </div>
                                </div>                                 
                                  ...
                                  <div class="span6 ">
                                    <div class="control-group">
                                      <label class="control-label" >Hosting Company<font color="red"> *</font></label>
                                          <div class="controls">
                                  <input type="text" placeholder="" class="input-xlarge" name="hosting_company" value="<?php echo $value['hosting_company'];?>" />
                                          </div>
                                        </div>
                                    </div>
                                </div>
